    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href = "<?php echo site_url('admin/teacher_form/add_teacher_form'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_teacher'); ?></a>
            </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card-body">
              ...
              <div class="table-responsive-sm mt-4">
                <table id="basic-datatable" class="table table-striped table-centered mb-0">
                  ...
                  <tbody>
                      <?php
<<<<<<< HEAD:application/views/backend/admin/moderator.php
...
=======
                       foreach ($teachers->result_array() as $key => $user): ?>
                          <tr>
                              <td><?php echo $key+1; ?></td>
                              <td>
                                  <img src="<?php echo $this->teacher_model->get_user_image_url($user['id']);?>" alt="" height="50" width="50" class="img-fluid rounded-circle img-thumbnail">
>>>>>>> 4ac3502a9f315e9183af34abc8b699f0410710ee:application/views/backend/admin/teacher.php
                              </td>
...
=======
                                        ...
                                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/teachers/delete/'.$user['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
>>>>>>> 4ac3502a9f315e9183af34abc8b699f0410710ee:application/views/backend/admin/teacher.php
                                    </ul>
                                </div>
                              </td>
