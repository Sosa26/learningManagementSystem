...
class Moderator_model extends CI_Model {
    ...
    public function get_admin_details() {
        return $this->db->get_where('moderator', array('role_id' => 1));
    }
    ...
    public function check_duplication($action = "", $email = "", $user_id = "") {
        $duplicate_email_check = $this->db->get_where('moderator', array('email' => $email));
    ...
    public function unlock_screen_by_password($password = "") {
        ...
        return $this->db->get_where('moderator', array('id' => $this->session->userdata('user_id'), 'password' => $password))->num_rows();
    }
    ...
    public function get_instructor($id = 0) {
        if ($id > 0) {
            ...
            if ($this->check_if_instructor_exists()) {
                ...
                return $this->db->get('moderator')->result_array();
            }
            else {
                return array();
            }
    ...
    public function get_instructor_list() {
        ...
        if (count($instructor_ids) > 0) {
            ...
            $query_result = $this->db->get('moderator');
        }else {
